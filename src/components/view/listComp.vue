                ...
                class="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
                  ...
                  <div class="mt-10 font-mono">                                    
                    <label class="block font-medium text-sm text-gray-600 w-full">
                      ...
                      <div class="mt-7">
                          <button type="submit" @click="getWeather()" class="bg-green-900 w-full py-3 rounded-xl text-white shadow-xl hover:shadow-inner focus:outline-none transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
                            Actualiza
                          </button>                       
                      </div>
