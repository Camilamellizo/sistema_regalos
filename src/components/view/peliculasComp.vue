<template>
    <div >
        ...
        <form class="text-white font-mono text-xl">
        ...
        <button type="submit" v-on:click="ApiCall()" class="text-white bg-white rounded-r-lg"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="container px-5 py-2 mx-auto lg:pt-12 lg:px-32">
                <div class="flex flex-wrap -m-1 md:-m-2">
                    <div class="flex flex-wrap w-1/3"  id="response" v-for="movie in movies" :key=movie.name>
                        ...
                        <div class="mb-6 px-2">
                            <h4 class="text-white font-mono">{{ movie.name }}</h4>
                        </div>
                    </div>
                </div>
            </div>
